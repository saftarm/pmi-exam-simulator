...
import type { SessionAnswerValue, SessionAnswersMap } from '../utils/sessionAnswers';
...
export default function QuestionMap({ total, currentIndex, answers, flagged, onSelect }: QuestionMapProps) {
  return (
      ...
      <div className="flex-1 overflow-y-auto p-md custom-scrollbar">
        <div className="grid grid-cols-5 gap-sm">
          {Array.from({ length: total }, (_, i) => {
            ...
            const isAnswered = hasAnswer(answers[i]);
