...
public class AnalyticsService(
    ...
    ISiteSettingsRepository siteSettingsRepository) : IAnalyticsService
{
    private readonly ApplicationDbContext _context = context;
    private readonly ISiteSettingsRepository _siteSettingsRepository = siteSettingsRepository;
    ...
    public async Task<Result<PassRateAnalyticsDto>> GetPassRateAsync(CancellationToken ct = default)
    {
        ...
        var threshold = settings.PassThreshold;
        ...
        var passCount = completed.Count(s => s >= threshold);
