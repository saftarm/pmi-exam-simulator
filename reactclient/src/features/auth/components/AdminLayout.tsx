...
import { ADMIN_APP_NAME } from '../../../shared/constants/branding';
...
function AdminAccountFooter({ onNavigate }: AdminAccountFooterProps) {
...
function AdminSidebar({ onNavigate }: AdminAccountFooterProps) {
  const { user } = useAuth();
...
export function AdminTopBar({ title, children, showNewExam, onNewExam }: AdminTopBarProps) {
  const navigate = useNavigate();
