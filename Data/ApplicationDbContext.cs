           ...
           .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<ExamAttempt>()
              ...
              .HasComputedColumnSql(
                  "CASE WHEN \"TotalQuestions\" = 0 THEN 0.0 ELSE (\"ScorePoints\"::numeric / \"TotalQuestions\"::numeric) * 100 END",
                  stored: true
                  );
            ...
            .HasOne<User>()
            .WithMany(u => u.DomainPerformances)
            .HasForeignKey(dp => dp.UserId)
            .OnDelete(DeleteBehavior.Restrict);

            modelBuilder.Entity<DomainPerformance>()
                .Property(dp => dp.TotalCorrect)
                .HasColumnType("decimal(8,2)");
            ...
            modelBuilder.Entity<DomainPerformance>()
            .HasOne(dp => dp.Exam)
            .WithMany(e => e.DomainPerformances)
