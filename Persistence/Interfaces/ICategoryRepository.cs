...
namespace TestAPI.Persistence.Interfaces
{
    public interface ICategoryRepository
    {
        ...
        Task<int> GetExamCountByCategoryIdAsync(Guid categoryId, CancellationToken ct = default);
        Task<Dictionary<Guid, int>> GetExamCountsByCategoryAsync(CancellationToken ct = default);
    }
}
