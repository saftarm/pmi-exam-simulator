...
import { getAdminExamDetails, publishExam, getAllExams } from '../api';
import { getDomainsByExam } from '../../admin-categories/api';
...
import { DetailPageSkeleton } from '../../../shared/components/loading';

export default function AdminExamDetailPage() {
  const { examId = '' } = useParams();
  const navigate = useNavigate();
  const [exam, setExam] = useState<ExamDetailsDto | null>(null);
  const [examMeta, setExamMeta] = useState<ExamSummaryDto | null>(null);
