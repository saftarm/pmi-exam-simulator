...
import { getPublicSettings } from '../services/publicStatsService';
import { resolvePostLoginPath, resolveAuthenticatedHomePath } from '../utils/postLoginPath';
...
export default function AuthPage() {
  ...
  const { login, register, isAuthenticated, user, authReady, profileLoading } = useAuth();
