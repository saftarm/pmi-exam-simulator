        ...
        <div className="min-h-screen flex flex-col bg-[#F4F5F7]">
            ...
            <main className="flex-1">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-xl">
                        <div className="bg-white rounded-xl border border-outline-variant p-xl shadow-sm">
                            ...
                            <p className="text-on-surface-variant mb-md leading-relaxed">
                                PMI Exam Simulator exists to close the gap between studying theory and performing under
                                exam conditions. We provide realistic question pools, timed sessions, and actionable
                                feedback so you know exactly where to focus next.
                            </p>
                        </div>

                        <div className="bg-white rounded-xl border border-outline-variant p-xl shadow-sm">
                            <h2 className="font-headline-lg text-headline-lg text-primary mb-md">What you can do</h2>
                            <ul className="space-y-md">
                                {[
                                    ...
                                    <li key={item} className="flex items-start gap-sm text-on-surface-variant">
                                        <Icon name="check_circle" className="text-secondary-container shrink-0 mt-xs" style={{ fontSize: 20 }} />
                                        {item}
                                    </li>
                                ))}
                            </ul>
                ...
                <section className="bg-white border-y border-outline-variant py-xl">
                    <div className="max-w-container-max mx-auto px-margin-desktop">
                        <h2 className="font-headline-lg text-headline-lg text-primary mb-lg text-center">Who it&apos;s for</h2>
                ...
                <section className="max-w-container-max mx-auto px-margin-desktop py-xl">
                    <h2 className="font-headline-lg text-headline-lg text-primary mb-xl text-center">How it works</h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-lg">
                        {STEPS.map((step, index) => (
                            ...
                            >
                                ...
                                <h3 className="font-headline-md text-headline-md text-primary mt-sm mb-sm">{step.title}</h3>
