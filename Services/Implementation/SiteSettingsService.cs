    ...
    IValidatorResolver validatorResolver) : ISiteSettingsService
{
    ...
    public async Task<Result<SiteSettingsDto>> UpdateAsync(UpdateSiteSettingsDto dto, CancellationToken ct = default)
    {
        ...
        settings.DefaultExamDuration = dto.DefaultExamDuration;
        settings.PassThreshold = dto.PassThreshold;
        settings.NotifyOnNewUser = dto.NotifyOnNewUser;
        settings.NotifyOnExamComplete = dto.NotifyOnExamComplete;
    ...
    private static SiteSettingsDto MapToDto(Entities.SiteSettings settings) => new()
    {
        ...
        NotifyOnNewUser = settings.NotifyOnNewUser,
        NotifyOnExamComplete = settings.NotifyOnExamComplete,
    };
}
