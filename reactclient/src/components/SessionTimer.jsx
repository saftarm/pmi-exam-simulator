...
export default function SessionTimer({ durationMinutes = 230, onExpire }) {
    ...
    return (
        <div className="flex items-center gap-sm">
            ...
            <span className={`font-mono text-headline-md font-semibold ${isWarning ? 'text-error animate-pulse' : 'text-secondary-container'}`}>
                {formatTime(seconds)}
            </span>
        </div>
    );
        ...
        <header className="bg-primary-container text-white h-16 flex items-center justify-between px-margin-desktop shrink-0 z-50">
            ...
            <div className="flex items-center gap-lg">
                <div className="hidden md:flex flex-col items-end">
                    <span className="font-label-sm text-on-primary-container uppercase tracking-widest">Progress</span>
                    <div className="flex items-center gap-sm">
