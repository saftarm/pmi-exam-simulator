...
namespace TestAPI.Persistence.Interfaces
{
    public interface IExamAttemptRepository
    {
        ...
        Task<bool> HasActiveSessionAsync(Guid userId, Guid examId, CancellationToken ct = default);
        ...
        Task<IReadOnlyDictionary<DateOnly, int>> GetCompletedAttemptVolumeByDayAsync(
            DateTime fromDate,
            CancellationToken ct = default);
        Task<IReadOnlyList<decimal>> GetCompletedAttemptScoresAsync(CancellationToken ct = default);
    }
}
