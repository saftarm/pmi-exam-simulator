...
export default function AdminExamEditPage() {
    ...
    return (
        <AdminLayout title={`Edit: ${exam?.title || 'Exam'}`}>
            ...
            <form onSubmit={handleSaveExam} className="bg-white rounded-xl border border-outline-variant shadow-sm p-lg mb-lg max-w-xl space-y-md">
            ...
            <div className="bg-white rounded-xl border border-outline-variant shadow-sm p-lg">
                ...
                {domains.length === 0 ? (
                    ...
                    <div className="space-y-md">
                        {domains.map((domain) => (
                            <div key={domain.id} className="border border-outline-variant rounded-lg p-md space-y-sm">
                                <input
                                    value={domain.title || ''}
